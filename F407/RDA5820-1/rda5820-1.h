#ifndef __RDA5820_1_H
#define __RDA5820_1_H	 
#include "sys.h"
#include "iic2.h"   
...
void RdaSeek_1(void);
u8 RDA5820_1_Init(void);					//初始化		 				    
void RDA5820_1_WR_Reg(u8 addr,u16 val);	//写RDA5820寄存器
u16 RDA5820_1_RD_Reg(u8 addr);			//读RDA5820寄存器
void RDA5820_1_RX_Mode(void);				//设置RDA5820为RX模式
void RDA5820_1_TX_Mode(void);				//设置RDA5820为TX模式
