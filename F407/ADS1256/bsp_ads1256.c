...
*	文件名称 : bsp_ads1256.c
*	版    本 : V1.0
*	说    明 : 推荐该ADS1256模块代码与STMF407使用，采用SPI接口。
*			 
*********************************************************************************************************
*/
...
void ADS1256_StartScan(uint8_t _ucScanMode)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_SYSCFG, ENABLE);//使能SYSCFG时钟  f407
	/* Connect EXTI3 Line to PE3 pin */
	SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOE, EXTI_PinSource3);//PE3 连接到中断线3  f407
...
void ads1256_allocation() //配置ads1256
{
	uint8_t ch_num;
	uint8_t i;
	/* 设置PGA增益，数据更新速率 */
