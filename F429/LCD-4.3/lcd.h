...
void LCD_DrawPoint(u16 x,u16 y, u16 Colour);											//画点
void LCD_Fast_DrawPoint(u16 x,u16 y,u16 color);								//快速画点
u16  LCD_ReadPoint(u16 x,u16 y); 											         //读点 
void LCD_Draw_Circle(u16 x0,u16 y0,u8 r, u16 Colour);						 			//画圆
void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2,u16 Colour);							//画线
void LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2, u16 Colour);		   				//画矩形
void LCD_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 color);		   				//填充单色
void LCD_Color_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 *color);				//填充指定颜色
void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode,u16 Colour);						//显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size,u16 Colour);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode,u16 Colour);				//显示 数字  颜色
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p,u8 mode,u16 Colour);		//显示一个字符串,12/16字体
void LCD_ShowString2(u16 x,u16 y,u16 width,u16 height,u8 size,const u8 *p,u8 mode,u16 Colour);//显示一个字符串2,12/16字体
void LCD_Showchinese(u16 x,u16 y,u16 width,u16 height,u8 num,u8 size,u8 mode,u16 Colour); //显示一个汉字
void LCD_Paintingform(u16 x,u16 y,u16 l,u16 w,u16 x1,u16 y1,u16 Colour);              //画表格
void LCD_WriteReg(u16 LCD_Reg, u16 LCD_RegValue);
u16 LCD_ReadReg(u16 LCD_Reg);
void LCD_WriteRAM_Prepare(void);
void LCD_WriteRAM(u16 RGB_Code);
void LCD_SSD_BackLightSet(u8 pwm);							//SSD1963 背光控制
void LCD_Scan_Dir(u8 dir);									//设置屏扫描方向，0~7表示8个方位，其中0，3表示竖屏，5，6表示横屏
